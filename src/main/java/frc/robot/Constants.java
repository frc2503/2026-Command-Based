...
public final class Constants {
  ...
  public final class IntakeConstants {
    ...
    public static final double INTAKE_ARM_ENCODER_OFFSET = -0.3;
    public static final Angle INTAKE_ARM_UP_ANGLE = Units.Rotation.of(0.11);
    public static final Angle INTAKE_ARM_DOWN_ANGLE = Units.Degree.of(0.);
